...
# sts2 : generic response (high pass filter). More complex representation depend on generation
sts2 = {'gain': 1.2982e8,
	'sensitivity': 1500,
...
# AGECODAGIS
# noemax (20s) - From the Agecodagis website - values for the 034-0097-0.PZ - BUT DEPENDS ON the Sensor ID !!!!
noemax = {'gain': 1.,
	'sensitivity' : 1500.,
...
t120pa = t120 
# Trillium 240 (!!! carefull second generation. Sensitivity is 1196.6 for first generation)
...
q330hr = {'lsb': 5.96047016188637e-07} # !! Only for channels 1-3. channels 4-6 equivalent to q330sr
q330=q330sr # default for Q330
q330s=q330 # default for Q330S
# Nanometrics
taurus40pp={'lsb' : 2.5000075000225e-06} # !!! 40V peak to peak correspond to a gain of 0.4
taurus16pp={'lsb' : 1.000003000009e-06} # !!! 16V peak to peak correspond to a gain of 1
taurus8pp={'lsb' : 5.000015000045e-07} # !!! 8V peak to peak correspond to a gain of 2
taurus4pp={'lsb' : 2.5000075000225e-07} # !!! 4V peak to peak correspond to a gain of 4
